...
describe('Given I am at random tag page', () => {
  let tag
  ...
  describe('And there are three destinations for this in the database', () => {
    ...
    describe('When I look to be first card in isolation', () => {
