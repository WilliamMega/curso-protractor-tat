...
describe('Given I am at a random edit destination page', () => {
  let editDestination
  ...
  describe('When I submit the form with less than the minimun required characters', () => {
    beforeEach(() => {
      editDestination
        .form
        .submintFormAfterClearingAndFillingItWith('Ab', 'Abcdefghi')
    })
  ...
  describe('When sucessfully submitting for the form with a new name and description', () => {
    ...
    beforeEach(() => {
      ...
      editDestination
        .form
        .submintFormAfterClearingAndFillingItWith(randomUuid, fiveRandomWords)
    })

    it('Then I am redirected to the destination view page, and I see the updated info', () => {
